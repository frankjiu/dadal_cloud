...
/**
 * Description: Date: 19-1-24 下午3:37
 *
 * @author ujued
 */
@Configuration
...
public class TMAutoConfiguration {
	...
	public FastStorageProvider fastStorageProvider(RedisTemplate<String, Object> redisTemplate, StringRedisTemplate stringRedisTemplate,
