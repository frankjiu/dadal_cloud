package com.modules.solr.service.impl;
...
import com.modules.solr.repository.ArticleRepository;
import com.modules.solr.repository.SolrCompanyRepository;
import com.modules.solr.service.SolrCompanyService;
	...
	public SolrCompany importAll() {
		...
		try {
			...
			for (Article article : list) {
				...
				document.addField("name", article.getTitle());
				document.addField("c_guard_machine", article.getContent());
