package com.modules.mq.service.impl;
...
import com.modules.mq.service.ProducerService;

/**
 * @author xinbe 消息生产者实现类 发送特定消息到指定队列 jmsTemplate 用于装载消息的broker容器 msg 待发消息
 *         destination 发送队列
 */
@Service
